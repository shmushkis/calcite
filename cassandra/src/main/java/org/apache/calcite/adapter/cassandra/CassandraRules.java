 ...
 * {@link CassandraRel#CONVENTION MONGO}
 * calling convention.
 */
public class CassandraRules {
   ...
   */
  private static class CassandraFilterRule extends CassandraConverterRule {
    private static final CassandraFilterRule INSTANCE = new CassandraFilterRule();

    private CassandraFilterRule() {
      super(LogicalFilter.class, Convention.NONE, CassandraRel.CONVENTION,
          "CassandraFilterRule");
    }
