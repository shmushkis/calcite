...
In the following, *geom* is a GEOMETRY;
*geomCollection* is a GEOMETRYCOLLECTION;
*point* is a point;
*lineString* is a LINESTRING;
*iMatrix* is an intersection matrix;
...
*gml* is a character string containing GML;
*wkt* is a character string containing WKT;
*wkb* is a binary string containing WKB.
...
| o | ST_MLineFromText(wkt [, srid ]) | Converts Well-Known Text → MULTILINESTRING
| o | ST_MPointFromText(wkt [, srid ]) | Converts Well-Known Text → MULTIPOINT
| o | ST_MPolyFromText(wkt [, srid ]) Converts Well-Known Text → MULTIPOLYGON
| o | ST_PointFromText(wkt [, srid ]) | Converts Well-Known Text → POINT
| o | ST_PolyFromText(wkt [, srid ]) | Converts Well-Known Text → POLYGON

Not implemented:

* ST_AsBinary(geom) GEOMETRY → Well Known Binary
...
* ST_PointFromWKB(wkb [, srid ]) Well Known Binary → POINT
* ST_PolyFromWKB(wkb [, srid ]) Well Known Binary → POLYGON
