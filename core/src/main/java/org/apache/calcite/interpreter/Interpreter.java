...
public class Interpreter extends AbstractEnumerable<Object[]> {
  ...
  public Source source(RelNode rel, int ordinal) {
    ...
    if (sink instanceof ListSink) {
      ...
      return new EnumerableProxySource(((EnumerableProxySink) sink).enumerable.enumerator());
    }
  ...
  private static class EnumerableProxySink implements Sink {
    ...
    @Override
    public void setSourceEnumeratable(Enumerable<Row> enumerable) {
  ...
  private static class EnumerableProxySource implements Source {
    ...
    public EnumerableProxySource(Enumerator<Row> enumerator) {
  ...
  private static class ListSink implements Sink {
    ...
    @Override
    public void setSourceEnumeratable(Enumerable<Row> enumerable) throws InterruptedException {
      // just copy over the source into the local list
      EnumerableProxySource source = new EnumerableProxySource(enumerable.enumerator());
      Row row;
