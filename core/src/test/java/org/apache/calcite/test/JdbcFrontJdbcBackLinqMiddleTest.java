...
public class JdbcFrontJdbcBackLinqMiddleTest {
  ...
  @Test public void testPlan3() {
    ...
    that()
        ...
        .planContains(
            ").join(org.apache.calcite.schema.Schemas.queryable(root, root.getRootSchema().getSubSchema(\"foodmart2\"), java.lang.Object[].class, \"inventory_fact_1997\").asEnumerable().groupBy(");
  }
}
